...
#
# "2007-11-23"
LIBCURL_TIMESTAMP = "2022-01-05"

CURL_VERSION_BITS     = lambda x, y, z: (x << 16 | y << 8 | z)
CURL_AT_LEAST_VERSION = lambda x, y, z: (LIBCURL_VERSION_NUM >= CURL_VERSION_BITS(x, y, z))
